<template>
  <button :title="title" v-on:click="control" class="manage-user-screen mr-[0.5rem]">
    <svg  width="20" height="20" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
      ...
      <g >
        <path :fill="client.media.media.remote.camera ? '#377E47' : '#aaaaaa'" d="M79.155,24.392c-1.313-0.906-3.014-1.149-4.525-0.65l-12.436,3.119v-4.977c0-5.754-4.682-10.436-10.436-10.436H10.436
          ...
          V52.997z"/>
        <path :fill="client.media.media.remote.camera ? '#377E47' : '#aaaaaa'" d="M45.105,38.207L23.139,25.523c-0.928-0.536-2.072-0.536-3,0s-1.5,1.526-1.5,2.598v25.365c0,1.072,0.572,2.063,1.5,2.598
